...
export function AddEditNeuroCoreModal({
  ...
  return (
    <>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ex: Varejo, Saúde, Serviços" {...field} disabled={isViewMode} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="url" placeholder="https://api.example.com" {...field} disabled={isViewMode} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="password"
                        placeholder={isEditMode ? "Deixe em branco para manter o atual" : "Secret token da API"}
                        {...field}
                        disabled={isViewMode}
                      />
                    </FormControl>
                    ...
                    {isEditMode && (
                      <FormDescription>
                        Deixe em branco para manter o secret atual. Digite um novo valor apenas se desejar alterá-lo.
                      </FormDescription>
                    )}
                  </FormItem>
                )}
              ...
              <div className="space-y-4">
                ...
                {associatedAgentsList.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    {!isViewMode && <p className="text-sm">Clique em "Adicionar Agente" para associar</p>}
                  </div>
                ) : (
              ...
              <DialogFooter>
                {isViewMode ? (
                  ...
                  <>
                    ...
                    <Button type="submit">{isEditMode ? "Salvar Alterações" : "Adicionar NeuroCore"}</Button>
                  </>
                )}
              </DialogFooter>
            </form>
      ...
      <AlertDialog open={removeAgentModal.open} onOpenChange={(open) => setRemoveAgentModal({ open, agentId: null })}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Desassociar Agente</AlertDialogTitle>
            <AlertDialogDescription>
              Para confirmar, digite <strong>&quot;desassociar agente&quot;</strong> no campo abaixo:
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="space-y-4">
            <Input
