...
export default function PerfilClientePage() {
  ...
  const displayAvatarUrl = perfilForm.watch("avatarUrl") || user.avatarUrl || `https://api.dicebear.com/7.x/avataaars/svg?seed=${user.fullName}`
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="+55 11 98765-4321" disabled={isSavingProfile} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="https://..." disabled={isSavingProfile} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="12.345.678/0001-90" disabled={isSavingTenant} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="+55 11 98765-4321" disabled={isSavingTenant} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
