...
export function AddEditAgentModal({ open, onOpenChange, agent, onSave }: AddEditAgentModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{isEditMode ? "Editar Agente IA" : "Adicionar Novo Agente IA"}</DialogTitle>
          <DialogDescription>
            {isEditMode
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select
                    onValueChange={(value) =>
                      field.onChange(value === "null" ? null : (value as AgentGender))
                    }
            ...
            <DialogFooter>
              ...
              <Button type="submit">{isEditMode ? "Salvar Alterações" : "Adicionar Agente"}</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
