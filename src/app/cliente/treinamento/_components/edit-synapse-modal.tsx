...
export function EditSynapseModal({ open, onOpenChange, synapse, onSave }: EditSynapseModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Atualize as informações da synapse.</DialogDescription>
        </DialogHeader>
