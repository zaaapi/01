      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh]">
          <DialogHeader>
            ...
            <DialogDescription>Gerencie as synapses desta base de conhecimento</DialogDescription>
          </DialogHeader>
                  ...
                  <TableBody>
                    {baseSynapses.map((synapse) => (
                      <TableRow key={synapse.id}>
                        ...
                        <TableCell className="max-w-xs truncate">{synapse.description}</TableCell>
                        <TableCell>
                          <Badge
                            variant={
