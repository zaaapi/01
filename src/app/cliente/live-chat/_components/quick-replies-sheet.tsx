...
export function QuickRepliesSheet({
  ...
  const { fetchQuickReplyTemplates, deleteQuickReplyTemplate } = useData()
                ...
                {quickReplies.map((qr) => (
                  ...
                  >
                    ...
                    <div className="flex gap-1 flex-shrink-0">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => handleDeleteClick(qr)}>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{editingReply ? "Editar" : "Adicionar"} Resposta Rápida</DialogTitle>
          <DialogDescription>
            {editingReply
