          ...
          <ScrollArea className="h-[500px] mt-4">
            ...
            <TabsContent value="configuracoes" className="space-y-4">
              <Form {...formConfiguracao}>
                <form
                  onSubmit={formConfiguracao.handleSubmit(handleSaveConfiguracao)}
                  className="space-y-4"
                >
                  <FormField
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Meio principal de comunicação do agente</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
            ...
            <TabsContent value="persona" className="space-y-4">
              <Form {...formPersonaComportamento}>
                <form
                  onSubmit={formPersonaComportamento.handleSubmit(handleSavePersonaComportamento)}
                  className="space-y-4"
                >
                  <FormField
            ...
            <TabsContent value="instrucoes">
              <KanbanBoard items={agent.instructions} type="instructions" agentId={agent.id} />
            </TabsContent>

            {/* Tab Limitações */}
            <TabsContent value="limitacoes">
              <KanbanBoard items={agent.limitations} type="limitacoes" agentId={agent.id} />
            </TabsContent>

            {/* Tab Roteiro */}
            <TabsContent value="roteiro">
              <KanbanBoard items={agent.conversationRoteiro} type="roteiro" agentId={agent.id} />
            </TabsContent>

            {/* Tab Outras Instruções */}
            <TabsContent value="outras">
              <KanbanBoard items={agent.otherInstructions} type="outras" agentId={agent.id} />
            </TabsContent>
          </ScrollArea>
        </Tabs>
